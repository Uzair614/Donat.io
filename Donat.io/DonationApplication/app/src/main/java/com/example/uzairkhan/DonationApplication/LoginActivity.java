...
//                    mainUser = new User("Uzair", "uzk@gmail.com", "4200060777203", "03482269068");
                    Toast.makeText(getApplicationContext(), "User Authenticated: " + mainUser.getName(), Toast.LENGTH_SHORT).show();
